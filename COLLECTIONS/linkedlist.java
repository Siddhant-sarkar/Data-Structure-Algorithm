/*
Linkedlist are the java equivalent of the vector
they are the dynamically growing data structures

They are implemented form the list interface
it is faster in edditing the data rather than traversing the data 
since its is a linked-list
*/


/*
	NOTE:
		This is the list implementation of linkedlist 
		so no method like peek(),offer(Object o),poll() will never ever work on this
*/
import java.util.*;
...
/*		remove(int index ) : removes the element of the list from the Linkedlist
